...
use KCV\Dashboard\Infrastructure\Persistence\SqlServerPosterRepository;
...
$di->set('sqlServerPosterRepository', function() use ($di) {
    return new SqlServerPosterRepository($di->get('db'));
});